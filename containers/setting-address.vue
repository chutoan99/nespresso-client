...
<template lang="pug">
section#setting_my_address
  form#form
    .setting_label My Address
    .form_content
      .form_content-left
        .form_content-info
          span ADDRESS
          span Mr Leon Lu
          span Calea Bucure&#x219;ti nr. 1-87
          span 500326 Bra&#x219;ov 
        .form_content-btn
          button(type='submit')
            span EDIT ADDRESS
