...
const IsCartOverlay = ref(false)
const IsLoggedInnDropdown = ref(false)
const IsSignInDropdown = ref(false)
const IsSubList = ref(false)
const isSearchAction = ref(false)
const isSearchMobile = ref(false)

const ShowCart= (): void => {
  IsCartOverlay.value = true;
  // IsLoggedInnDropdown = false;
  IsSignInDropdown.value = false;
}

const CloseCart= (): void => {
  IsCartOverlay.value = false;
}

const onHandleLogin= (): void => {
  IsLoggedInnDropdown.value = !IsLoggedInnDropdown;
  // IsSignInDropdown = !IsSignInDropdown;
}
const HandelSubItem= (): void => {
  IsSubList.value = !IsSubList;
}
...
const handleInputFocus= () => {
  if (currentScreenWidth.value > 1023) {
...
const handleInputBlur= () => {
  ...
  if (currentScreenWidth.value <= 1024) {
    handleClickIcon();
  }
}
        ...
        .hamburger-menu
          ...
          ul.menu__box
            ...
            li
              ...
              .menu__item-content
                router-link.menu__item(to='/sustainability/recycling') Sustainability &amp; Recycling
                .nav_icon
                  svg(v-on:click='HandelSubItem' width='7' height='13' viewbox='0 0 7 13' fill='none' xmlns='http://www.w3.org/2000/svg')
                    path(fill-rule='evenodd' clip-rule='evenodd' d='M0.162718 0.162718C0.379676 -0.0542395 0.731435 -0.0542395 0.948393 0.162718L6.50395 5.71827C6.72091 5.93523 6.72091 6.28699 6.50395 6.50395L0.948393 12.0595C0.731435 12.2765 0.379676 12.2765 0.162718 12.0595C-0.0542395 11.8425 -0.0542395 11.4908 0.162718 11.2738L5.32544 6.11111L0.162718 0.948393C-0.0542395 0.731435 -0.0542395 0.379676 0.162718 0.162718Z' fill='white')
            ...
            li
              ...
              .menu__item-content
                router-link.menu__item(to='/store-location') Store Locator
                .nav_icon
                  svg(v-on:click='HandelSubItem' width='7' height='13' viewbox='0 0 7 13' fill='none' xmlns='http://www.w3.org/2000/svg')
                    path(fill-rule='evenodd' clip-rule='evenodd' d='M0.162718 0.162718C0.379676 -0.0542395 0.731435 -0.0542395 0.948393 0.162718L6.50395 5.71827C6.72091 5.93523 6.72091 6.28699 6.50395 6.50395L0.948393 12.0595C0.731435 12.2765 0.379676 12.2765 0.162718 12.0595C-0.0542395 11.8425 -0.0542395 11.4908 0.162718 11.2738L5.32544 6.11111L0.162718 0.948393C-0.0542395 0.731435 -0.0542395 0.379676 0.162718 0.162718Z' fill='white')
            ...
            li
              ...
              .menu__item-content
                router-link.menu__item(to='/contact-us') Contact
                .nav_icon
                  svg(v-on:click='HandelSubItem' width='7' height='13' viewbox='0 0 7 13' fill='none' xmlns='http://www.w3.org/2000/svg')
                    path(fill-rule='evenodd' clip-rule='evenodd' d='M0.162718 0.162718C0.379676 -0.0542395 0.731435 -0.0542395 0.948393 0.162718L6.50395 5.71827C6.72091 5.93523 6.72091 6.28699 6.50395 6.50395L0.948393 12.0595C0.731435 12.2765 0.379676 12.2765 0.162718 12.0595C-0.0542395 11.8425 -0.0542395 11.4908 0.162718 11.2738L5.32544 6.11111L0.162718 0.948393C-0.0542395 0.731435 -0.0542395 0.379676 0.162718 0.162718Z' fill='white')
            ...
            .modalCart_body
              ...
              .modalCart_footer
                ...
                button.modalCart_btn
                  router-link(to='/shopping/step-1') GO TO SHOPPING BAG
</template>
